...
Don't worry if the movie that you are looking for is not auto-suggested. Just type the movie name and click on "enter". You will be good to go eventhough if you made some typo error.
...
1. Install all the libraries mentioned in the [requirements.txt](https://github.com/nileshsurat143/Movie-Recommendation-System-with-Sentiment-Analysis/blob/master/requirements.txt) file.
